...
%
% Copyright (c) 2014-2025, Manu Mannattil.
% All rights reserved.
%
...
\usepackage{color}
\definecolor{bluesmoke}{rgb}{0.207843,0.415686,0.623529}
...
% OSF makes \textsl use ordinary italics.
...
\IfFileExists{\gitInfo}{\input{\gitInfo}}{
  ...
  \def\gitCommitterDateHuman{\gitError}
}
...
{\color{gray}\large\headerstyle{CURRICULUM VIT\AE} \hfill \normalsize\gitCommitterDateHuman}
\vskip2em
...
Phone: (+1)~857-287-1865\\
Email: \email{manu\_mannattil@seas.harvard.edu}
...
Broad interests in theoretical soft matter physics, statistical mechanics, and applied mathematics.
Recent studies address problems in phase separation, elasticity theory, wave mechanics, WKB theory, the geometry of soft materials, free-energy landscapes, and nonlinear dynamics.
...
Name in Malayalam: \hspace{-.3ex}\raisebox{-0.6ex}{\includegraphics[scale=0.92]{name-ml}}\hspace{.1ex},
and in Devanagari: \hspace{-.4ex}\raisebox{-0.7ex}{\includegraphics[scale=0.92]{name-dv}}\hspace{-0.15ex}.
...
% All India Senior School Certificate, May 2009.
...
Postdoctoral Fellow in Applied Mathematics, School of Engineering and Applied Sciences,\\
Harvard University; November 2025--.

Postdoctoral Fellow, School of Chemistry and School of Physics and Astronomy,\\
Tel Aviv University; October 2023--September 2025.
...
%   \item[1.] {\bname} and L.~Mahadevan, ``Maximizing diffusion-limited lifetimes of electrochemical systems'', forthcoming.
% \end{flexlabelled}
...
\begin{itemize}
\item \href{https://github.com/manu-mannattil/nolitsa}{NoLiTSA} -- a Python module for nonlinear time series analysis (2017)\\
...
\textsl{Theory of Microphase Separation in Elastomers}\\
 % School of Engineering and Applied Sciences, Harvard University, November 2025.
...
\textsl{Theory of Microphase Separation in Elastomers}\\
  StatPhys 29, Florence, July 2025.\\
  StatPoly, Venice, July 2025.

\textsl{A Linear Model for Elastic Phase Separation}\\
  BioSoft Day, Tel Aviv University, June 2024.

\textsl{Can One Hear the Shape of a Filament?}\\
  APS March Meeting '23, Las Vegas.

\textsl{Thermal Fluctuations of Singular Bar-Joint Mechanisms}\\
  Simons Center for Geometry and Physics, Stony Brook University, May 2022.\\
  APS March Meeting '22, Chicago.

\textsl{Thermal Fluctuations of Singular Networks}\\
  APS March Meeting '21, Virtual.

% \textsl{Topics in Nonlinear Time Series Analysis}\\
%   Indian Institute of Technology Kanpur, August 2015.
...
\emph{Journal of Applied Physics} and
\emph{Physics of Fluids}.
...
% Here, it's better to use \hfill instead of tabular to get properly left-right alignment.

Grader, PHY 741: Graduate Statistical Mechanics                                              \hfill \emph{Spring 2022} \\
Teaching Assistant, PHY 212: General Physics II (Electricity \& Magnetism)                   \hfill \emph{Spring 2020} \\
Teaching Assistant, AST 101: Our Corner of the Universe                                      \hfill \emph{Fall 2019}   \\
Course Instructor, PHY 212: General Physics II (Electricity \& Magnetism)                    \hfill \emph{Summer 2019} \\
Teaching Assistant, PHY 222: General Physics II Lab (Electricity \& Magnetism)               \hfill \emph{Spring 2019} \\
Teaching Assistant, PHY 211: General Physics I (Mechanics)                                   \hfill \emph{Fall 2018}   \\
Teaching Assistant, PHY 215: General Physics I for Majors (Mechanics)                        \hfill \emph{Fall 2018}   \\
Teaching Assistant, AST 101: Our Corner in the Universe                                      \hfill \emph{Summer 2018} \\
Teaching Assistant, PHY 212: General Physics II (Electricity \& Magnetism)                   \hfill \emph{Spring 2018} \\
Teaching Assistant, AST 101: Our Corner in the Universe                                      \hfill \emph{Fall 2017}
